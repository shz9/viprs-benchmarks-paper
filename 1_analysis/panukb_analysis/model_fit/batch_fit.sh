...
time_dict["hq_imputed_variants_maf001"]="02:00:00"
time_dict["hq_imputed_variants"]="04:00:00"


# Loop over the summary statistics files:
for sumstats_file in data/sumstats/panukb_sumstats/*/*.sumstats.gz
do
  ...
  do
    ...
    sbatch --time "${time_dict[$variant_set]}" -J "${variant_set}/${pop}/${pheno}" \
            1_analysis/panukb_analysis/model_fit/viprs_fit_job.sh "$sumstats_file" "$ld_dir/chr_*" "data/model_fit/panukb_sumstats/$variant_set/$pop/$pheno/"
